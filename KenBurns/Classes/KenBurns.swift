...
@objc public class KenBurnsImageView: UIView {
  ...
  public override var contentMode: UIView.ContentMode {
    didSet {
      currentImageView.contentMode = self.contentMode
  ...
  public func startAnimating() {
    ...
    if let firstIndex = subviews.index(of: currentImageView),
       let nextIndex = subviews.index(of: nextImageView),
  ...
  public func setImageQueue(withUrls urls:[URL], placeholders: [UIImage]?) {
    ...
    self.fetchImage(self.imageURLs!.read()!,
                    placeholder: self.imagePlaceholders?.read())
    self.currentImageView.size = self.size
    self.nextImageView.size = self.size
  ...
  public func pause()  {
    if updatesDisplayLink.isPaused == false {
  ...
  public func resume() {
    if updatesDisplayLink.isPaused {
